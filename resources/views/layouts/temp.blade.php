  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Keuangan Desa<sup>Citapen</sup></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('rtrw.index')}}">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('kas.index')}}">
          ...
          <span>Kas Desa</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{route('keperluan.index')}}">
          <i class="fas fa-fw fa-dollar-sign"></i>
          <span>Keperluan Desa</span></a>
      </li>


       <li class="nav-item">
        <a class="nav-link" href="{{route('sumbangan.index')}}">
          <i class="fas fa-fw fa-briefcase"></i>
          <span>Sumbangan Desa</span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('laporan.index')}}">
          ...
          <span>Laporan Keuangan Desa</span></a>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Halo <b>{{Auth::user()->name}} !</b></span>
              </a>
  ...
  <script>
    $(document).ready(function(){
      $('.btn-delete').click(function(e){
        ...
        var con = confirm("Really ?");
        if(con)
        {
          $('#form-delete').attr('action',href).submit();
        }
      });
    });
  </script>
